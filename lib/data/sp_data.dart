...
import 'package:themealdb_app/common/constans/shared_data_type.dart';
...
class SPData {
  ...
  Future<Object?> saveToSP(String key, SharedDataType type, dynamic value) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    try {
      switch (type) {
        case SharedDataType.bool:
  ...
  static Future<Object> resetSP() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    try {
